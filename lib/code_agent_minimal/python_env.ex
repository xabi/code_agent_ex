defmodule CodeAgentMinimal.PythonEnv do
  @moduledoc """
  ...
  nécessaires aux tools de CodeAgentMinimal.
  ...
  @doc """
  Initialise PythonX avec les dépendances par défaut de CodeAgentMinimal.
  """
  def init do
