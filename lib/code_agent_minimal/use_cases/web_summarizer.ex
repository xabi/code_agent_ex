defmodule CodeAgentMinimal.UseCases.WebSummarizer do
  @moduledoc """
  ...
  ## Exemple
      ...
      alias CodeAgentMinimal.UseCases.WebSummarizer
  ...
  alias CodeAgentMinimal.{CodeAgent, AgentConfig, Tool}
  alias CodeAgentMinimal.UseCases.UrlTracker
