defmodule CodeAgentEx.MoondreamApi do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> {:ok, image_url} = CodeAgentEx.MoondreamApi.file_to_image_url("/path/to/image.jpg")
  ...
  ## Examples
      ...
      iex> {:ok, image_url} = CodeAgentEx.MoondreamApi.binary_to_image_url(binary, "image/jpeg")
      {:ok, "data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQ..."}
