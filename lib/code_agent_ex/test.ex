defmodule CodeAgentEx.Test do
  @moduledoc """
  Tests pour le CodeAgent.

  Utilisation dans iex:

      CodeAgentEx.Test.run_all()
      CodeAgentEx.Test.test_simple_calc()
      CodeAgentEx.Test.test_with_tool()
      CodeAgentEx.Test.test_list_manipulation()
  """

  alias CodeAgentEx.CodeAgent
  alias CodeAgentEx.Tool
  alias CodeAgentEx.Tools.WikipediaTools
  alias CodeAgentEx.Tools.ImageTools
  alias CodeAgentEx.Tools.MoondreamTools
  alias CodeAgentEx.AgentConfig
  require Logger
