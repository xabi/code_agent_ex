defmodule CodeAgentEx.IexTest do
  ...
  """
  def test8 do
    alias CodeAgentEx.{AgentConfig, Tools.PythonTools}
  ...
  """
  def test9 do
    alias CodeAgentEx.{AgentConfig, Tools.WikipediaTools}
  ...
  """
  def test10 do
    alias CodeAgentEx.{AgentConfig, Tools.FinanceTools}
  ...
  """
  def test11 do
    alias CodeAgentEx.{AgentConfig, Tools.SmolAgentsTools}
  ...
  """
  def test12 do
    alias CodeAgentEx.{AgentConfig, Tools.MoondreamTools}
  ...
  ## Exemples
      ...
      iex> CodeAgentEx.IexTest.test_custom("Calculate 10 + 5 * 2")
      iex> CodeAgentEx.IexTest.test_custom("Create a list [1,2,3,4,5] and sum it")
  """
  ...
  """
  def test15 do
    alias CodeAgentEx.{AgentConfig, Tools.ImageTools}
  ...
  def test19 do
    ...
    # Start the agent
    {:ok, agent_pid} = CodeAgentEx.AgentSupervisor.start_agent(config, self())
    CodeAgentEx.AgentServer.run(agent_pid, task)
  ...
  defp handle_validation_loop(agent_pid) do
    receive do
      ...
      {:pending_validation, ^agent_pid, thought, code} ->
        ...
        CodeAgentEx.AgentServer.continue(agent_pid, :approve)
        handle_validation_loop(agent_pid)
      ...
      {:final_result, ^agent_pid, result} ->
        ...
        IO.puts(result)
        IO.puts("\n")
        CodeAgentEx.AgentServer.stop(agent_pid)
        :ok
  ...
  """
  def test20 do
    alias CodeAgentEx.{AgentConfig, AgentOrchestrator, Tool}
  ...
  """
  def test22 do
    alias CodeAgentEx.{AgentConfig, AgentOrchestrator, AgentServer, Tool}
  ...
  defp run_test24(api_key) do
    ...
    validation_handler =
      CodeAgentEx.AIValidator.create_handler(
        verbose: true,
    ...
    {:ok, orch} =
      CodeAgentEx.AgentOrchestrator.start_link(config,
    ...
    case CodeAgentEx.AgentOrchestrator.run_task(orch, task) do
      {:ok, result} ->
        IO.puts("""
        ...
        CodeAgentEx.AgentOrchestrator.stop(orch)
        {:ok, result}
  ...
  def help do
    IO.puts("""
    📚 CodeAgentEx.IexTest - Fonctions disponibles:
